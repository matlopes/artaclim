 ...
 */
function formulaires_parametrerindicateur_carto_charger_dist(
	$id_indicateur,$url
) {
	$valeurs = array();
 ...
 * 
 */
function formulaires_parametrerindicateur_carto_verifier_dist(
	$id_indicateur,$url
) {
 ...
 *
 */
function formulaires_parametrerindicateur_carto_traiter_dist(
	$id_indicateur,$url
) {
	$res=array();
