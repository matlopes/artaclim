 ...
 **/
function formulaires_connexionpublic_charger_dist($cible = '', $login = '', $prive = null) {
 ...
 **/
function formulaires_connexionpublic_verifier_dist($cible = '', $login = '', $prive = null) {
 ...
 **/
function formulaires_connexionpublic_traiter_dist($cible = '', $login = '', $prive = null) {
